...
const UserSelector = (props) => {
	...
	const [L_QuickSearch, R_QuickSearch, E_QuickSearch, M_QuickSearch] =
		useRequest(SearchModel.quickSearch)
	...
	return (
		<div className={classnames("user-selector", { ["open"]: searchValue })}>
			<antd.Input
			...
			{searchResult && (
				<div className="user-selector_results">
...
export const openModal = (props) => {
	return app.layout.modal.open("user_selector", () => (
		<UserSelector {...props} />
	))
}
