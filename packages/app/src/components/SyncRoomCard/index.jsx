			...
			<>
				<div className="sync-room_subcard top">
					<div className="sync-room_name">
						<span>
							<Icons.RefreshCcw />{" "}
							{this.state.roomData?.options?.title ??
								"Untitled room"}
						</span>
					</div>
					...
					<div className="sync-room_share_btns">
						...
						<Badge dot={this.state.notReadedMessages}>
							<Button
								size="small"
				...
				<div className="sync-room_card">
					<div className="sync-room_users">
						{Array.isArray(this.state.roomData?.connectedUsers) &&
							this.state.roomData?.connectedUsers.map(
								(user, index) => {
									return (
										<Dropdown
											menu={{
												items: this.generateUserMenu(
													user,
												),
												onClick: (event) => {
													this.handleUserMenuClick(
														event.key,
														user,
													)
												},
				...
				<div
					className={classnames("sync-room_subcard bottom", {
