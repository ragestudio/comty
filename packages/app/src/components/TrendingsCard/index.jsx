...
const TrendingsCard = (props) => {
	const [L_Trendings, R_Trendings, E_Trendings] = app.cores.api.useRequest(
		PostsModel.getTrendings,
	)
		...
		<div className="card">
			...
			<div className="card-content trendings">
				...
				{!L_Trendings &&
					!E_Trendings &&
					R_Trendings &&
					R_Trendings.length === 0 && <span>No trendings</span>}
				{!L_Trendings &&
					!E_Trendings &&
					R_Trendings &&
					R_Trendings.map((trending, index) => {
						return (
							<div
								key={index}
								className="trending"
