		...
		>
			<defs>
				...
				>
					<stop
						offset="0%"
						stopColor="rgba(225, 0, 209, 0.1)"
					/>
					<stop
						offset="25%"
						stopColor="rgba(233, 0, 182, 0.08)"
					/>
					<stop
						offset="50%"
						stopColor="rgba(240, 0, 154, 0.05)"
					/>
					<stop
						offset="100%"
				...
				>
					<stop
						offset="0%"
						stopColor="rgba(255, 96, 100, 0.2)"
					/>
					<stop
						offset="20%"
						stopColor="rgba(255, 96, 100, 0.16)"
					/>
					<stop
						offset="40%"
						stopColor="rgba(255, 96, 100, 0.12)"
					/>
					<stop
						offset="60%"
						stopColor="rgba(255, 96, 100, 0.08)"
					/>
					<stop
						offset="100%"
						stopColor="rgba(255, 96, 100, 0)"
					/>
				</radialGradient>
			</defs>
			<rect
