...
exports.waitForNewNode =
	exports.getOutputNodesName =
	exports.getInputNodesName =
	exports.unlinkPorts =
	exports.linkPorts =
	exports.unlinkNodesNameToId =
	exports.linkNodesNameToId =
	exports.getInputNodes =
	exports.getOutputNodes =
	exports.getNodes =
	exports.getPorts =
	exports.getLinks =
	exports.createPwThread =
		void 0
const library = require("./index.node")
function createPwThread(enableDebug) {
	library.createPwThread(
		enableDebug !== null && enableDebug !== void 0 ? enableDebug : false,
	)
}
...
function waitForNewNode(nodeName, direction, timeout) {
	return library.waitForNewNode(
		nodeName,
		direction !== null && direction !== void 0 ? direction : "Both",
		timeout !== null && timeout !== void 0 ? timeout : 5000,
	)
}
